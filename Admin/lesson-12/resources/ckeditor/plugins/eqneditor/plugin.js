...
CKEDITOR.plugins.add( 'eqneditor', {
	...
	{		
  	...
  	CKEDITOR.scriptLoader.load( [
			'/addsource/ckeditor/plugins/eqneditor/js/eq_config.js', 
			'/addsource/ckeditor/plugins/eqneditor/js/eq_editor-lite-16.js',
		]);
		...
		fileref.setAttribute("href", '/addsource/ckeditor/plugins/eqneditor/css/equation-embed.css');
